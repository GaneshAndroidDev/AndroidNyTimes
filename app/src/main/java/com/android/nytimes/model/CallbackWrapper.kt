...
import com.android.nytimes.common.Constants.HttpErrorMessage.Companion.FORBIDDEN
import com.android.nytimes.common.Constants.HttpErrorMessage.Companion.INTERNAL_SERVER_ERROR
import com.android.nytimes.common.Constants.HttpErrorMessage.Companion.TIMEOUT
import com.android.nytimes.common.Constants.HttpErrorMessage.Companion.UNAUTHORIZED
...
import com.android.nytimes.model.dto.response.ErrorResponse
...
abstract class CallbackWrapper<T : BaseResponse>(var apiClient: ApiClient) : DisposableObserver<T>() {
    ...
    private fun parseError(throwable: HttpException?): CustomException {
        val converter: Converter<ResponseBody, ErrorResponse> = apiClient.getClient().responseBodyConverter(ErrorResponse::class.java, emptyArray())
